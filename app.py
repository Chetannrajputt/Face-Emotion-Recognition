...
def main():
    ...
    {"iceServers": [{"urls": ["stun:stun.l.google.com:19302"]}]}
        ...
        The demo application is developed by Chetan Rajput using OpenCV-Python, CNN and Streamlit Frameworks.<p>
         <body>'''
        st.markdown(statement_html,True)
        st.write("Contact Details:")
        st.write("Chetan Rajput")
        st.write("LinkedIn Profile: https://www.linkedin.com/in/chetanrajput1311/")
